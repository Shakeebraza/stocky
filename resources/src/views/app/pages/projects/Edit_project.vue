<template>
  <div class="main-content">
    <breadcumb page="Edit Project" folder="Projects"/>
              ...
              <b-row>
                ...
                <b-col lg="4" md="6" sm="12">
                  <validation-provider name="Client">
                    <b-form-group slot-scope="{ valid, errors }" label="Client">
                      <v-select
                 ...
                 <b-col lg="4" md="6" sm="12">
                  <validation-provider name="Company">
                    <b-form-group slot-scope="{ valid, errors }" label="Company">
                      <v-select
                        :class="{'is-invalid': !!errors.length}"
                        :state="errors[0] ? false : (valid ? true : null)"
                ...
                <b-col lg="4" md="6" sm="12">
                  <validation-provider name="Assigned_Employees">
                    <b-form-group slot-scope="{ valid, errors }" label="Assigned Employees">
                      <v-select
                        :class="{'is-invalid': !!errors.length}"
                        :state="errors[0] ? false : (valid ? true : null)"
