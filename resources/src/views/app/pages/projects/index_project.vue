<template>
  <div class="main-content">
    <breadcumb page="Project List" folder="Projects"/>
      ...
      <b-row>
        ...
        <b-col lg="3" md="6" sm="12">
            <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
              <i class="i-Pause"></i>
              <div class="content">
                <p class="text-muted mt-2 mb-0">Not Started</p>
                <p
                  class="text-primary text-24 line-height-1 mb-2"
                >{{count_not_started}}</p>
              </div>
        ...
        <b-col lg="3" md="6" sm="12">
            <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
              ...
              <div class="content">
                <p class="text-muted mt-2 mb-0">In Progress</p>
                <p
                  class="text-primary text-24 line-height-1 mb-2"
                >{{count_in_progress}}</p>
              </div>
        ...
        <b-col lg="3" md="6" sm="12">
            <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
              <i class="i-Close"></i>
              <div class="content">
                <p class="text-muted mt-2 mb-0">Cancelled</p>
                <p
                  class="text-primary text-24 line-height-1 mb-2"
                >{{count_cancelled}}</p>
              </div>
