...
class SetupController extends Controller
{
    ...
    public function lastStep(Request $request)
    {
        ...
        try {
            Log::info('Starting lastStep process');
            $this->changeEnv([
                // Environment variables
            ]);
            Log::info('Environment variables changed');
            ...
            Log::info('Passport migrations run');
        
            Artisan::call('passport:install --force');
            Log::info('Passport installed');
        
            Storage::disk('public')->put('installed', 'Contents');
            Log::info('Installation file created');
        
        } catch (\Exception $e) {
            Log::error('Error in lastStep process: ' . $e->getMessage());
            return $e->getMessage();
        }
